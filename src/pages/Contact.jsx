        ...
        <div className="bg-white min-h-screen py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <motion.div
                    ...
                    className="bg-white-light p-8 rounded-2xl border border-slate-200/50 shadow-xl"
                >
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                name="name"
                                required
                                className="w-full bg-white border border-slate-200-light rounded-lg px-4 py-3 text-slate-900 focus:outline-none focus:border-aa-blue focus:ring-1 focus:ring-aa-blue transition-all"
